...
class DocumentsPage(LoggedPage, ErrorPage):
    ...
    @method
    class iter_documents_date_range(DictElement):
        # Used by rechercheCriteresDemat (date-range search), which returns mapDocuments instead of mapReleves.
        item_xpath = "data/rechercheCriteresDemat/mapDocuments/*/listeDocument"
        ignore_duplicate = True
